...
function promptcmd () {
  ...
  # Upper line fill
  local prompt_u=""
  local upper_fill_length=$(($current_width - $user_length - $dir_length - $devenv_length - 2))
  ...
  local prompt_ul="$line_color$line_ul$formatted_user$frame_line$formatted_devenv"
